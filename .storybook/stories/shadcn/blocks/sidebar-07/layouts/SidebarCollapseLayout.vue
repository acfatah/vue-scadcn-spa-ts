...
const activeTeam = ref(sidebar.teams[0])

function setActiveTeam(team: typeof sidebar.teams[number]) {
    ...
    <Sidebar collapsible="icon">
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuItem
                  v-for="(team, index) in sidebar.teams"
                  :key="team.name"
                  class="gap-2 p-2"
      ...
      <SidebarContent>
        ...
        <SidebarGroup class="group-data-[collapsible=icon]:hidden">
          ...
          <SidebarMenu>
            <SidebarMenuItem
              v-for="item in sidebar.projects"
              :key="item.name"
            >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger as-child>
                ...
                >
                  ...
                  <div class="grid flex-1 text-left text-sm leading-tight">
                    <span class="truncate font-semibold">{{ sidebar.user.name }}</span>
